    ...
    SubShader
    {
		Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
	            ...
	            return lerp(BaseColor, EffectColor, pow(1 - NdotV, Exponent));
            }
            ENDHLSL
        }
    }
